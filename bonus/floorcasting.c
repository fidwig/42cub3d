...
/*   Updated: 2024/12/06 17:04:06 by jsommet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//         while (++x < SW)
//         {
//             // Calculate the cell position based on the current
// floor coordinates
//             cell.x = (int)floor.x;
//             cell.y = (int)floor.y;

//             // Map floor coordinates to texture coordinates
//             texcoord.x = (int)(tex.width * (floor.x - cell.x)) &
// (tex.width - 1);
//             texcoord.y = (int)(tex.height * (floor.y - cell.y)) &
// (tex.height - 1);
...
// 			// t_dvec3	ray_dir = (t_dvec3){cos(cub->player.rot + M_PI)
//  + cam.plane.x * camera_x,
